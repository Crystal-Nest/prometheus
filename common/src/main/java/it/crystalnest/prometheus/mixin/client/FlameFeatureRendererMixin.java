...
public abstract class FlameFeatureRendererMixin {
  /**
   * Wraps the first call to {@link AtlasManager#get(SpriteId)} in the method {@link FlameFeatureRenderer#renderFlame(PoseStack.Pose, MultiBufferSource, EntityRenderState, Quaternionf, AtlasManager)}.<br>
   ...
   * @param sprite original material.
   * @param original the {@link Operation} for the modified method.
   * @param pose pose.
   * @param bufferSource buffer source.
   * @param state {@link EntityRenderState} of the entity that's burning.
  ...
  /**
   * Wraps the second call to {@link AtlasManager#get(SpriteId)} in the method {@link FlameFeatureRenderer#renderFlame(PoseStack.Pose, MultiBufferSource, EntityRenderState, Quaternionf, AtlasManager)}.<br>
